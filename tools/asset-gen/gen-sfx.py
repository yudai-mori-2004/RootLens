...
#
# ⚠ rec_stop_soft_0.4s.mp3 だけは合成しない (SOUNDS に無い = このスクリプトは触らない)。
#   シャッター風の元アセットを使う、 というユーザー確定の判断。 SOUNDS に戻さないこと。
#
...
SOUNDS: dict[str, dict] = {
    ...
    # 録画停止 (rec_stop_soft_0.4s) はここに無い: 元のシャッター風アセットを使う (冒頭の ⚠ 参照)
