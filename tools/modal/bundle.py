...
詳細は document/v0.1.3/tasks/09-pipeline-3-wilor-lerobot/README.md 参照。
...
def bundle_dataset(
    ...
    Args (query string):
        ...
        signed_mp4_key:   ぼかし済 MP4 の R2 オブジェクトキー (= Pipeline 2 出力)
    ...
    bucket_datasets = os.environ.get("R2_BUCKET_DATASETS", bucket_raw)
    ...
    s3.download_file(bucket_raw, signed_mp4_key, rgb_path)
