...
import { Shield, CheckCircle, XCircle, Search, FileCode, Fingerprint, Lock, Link as LinkIcon, BookOpen, Eye, AlertCircle, HelpCircle, Camera, Sparkles, Check, ExternalLink, ShieldCheck, Activity } from 'lucide-react';
