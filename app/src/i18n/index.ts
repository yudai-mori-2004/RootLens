...
const ja = {
  ...
  'upload.consentCheckNoThirdParty': '撮影に同意していない人物は、この動画に映り込んでいません。',
...
const en: Record<TranslationKey, string> = {
  ...
  'upload.consentCheckNoThirdParty': 'No one appears in this video who has not consented to being recorded.',
