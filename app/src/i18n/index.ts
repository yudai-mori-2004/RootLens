...
const ja: TranslationDict = {
  ...
  'share.menuEditCaption': 'キャプションを編集',
  'share.captionPlaceholder': 'キャプションを入力...',
  'share.captionSave': '保存',
  'share.captionSaved': '保存しました',
  'share.captionError': '保存に失敗しました',
  'share.action': 'シェア',
  'share.composing': '合成中...',
...
const en: TranslationDict = {
  ...
  'share.menuEditCaption': 'Edit caption',
  'share.captionPlaceholder': 'Add a caption...',
  'share.captionSave': 'Save',
  'share.captionSaved': 'Saved',
  'share.captionError': 'Failed to save',
  'share.action': 'Share',
