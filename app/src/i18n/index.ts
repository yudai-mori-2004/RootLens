...
const ja = {
  ...
  'capture.hud.recordingHint': '終わりたいときは、両手をカメラに向けて、グー、チョキ、を3回くり返してください。',
  ...
  'capture.tts.aimOk': 'ちょうどいい向きになりました。撮影を始めるときは、両手をカメラに向けて、グー、チョキ、を3回くり返してください。',
...
const en: Record<TranslationKey, string> = {
  ...
  'capture.hud.recordingHint': 'To finish, face both hands to the camera and alternate fist and peace sign three times.',
  ...
  'capture.tts.aimOk': 'The camera is aimed just right. To start recording, face both hands to the camera and alternate fist and peace sign three times.',
