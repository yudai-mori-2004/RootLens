...
export const TASKS: TaskDef[] = [
  {
    ...
    startIllustration: require('../../assets/tasks/fold-laundry/start.jpg'),
    endIllustration: require('../../assets/tasks/fold-laundry/end.jpg'),
  },
  {
    id: 'wash-dishes',
    name: 'Wash dishes',
    ...
    startIllustration: require('../../assets/tasks/wash-dishes/start.jpg'),
    endIllustration: require('../../assets/tasks/wash-dishes/end.jpg'),
  },
  {
    id: 'cook-pasta',
    name: 'Cook pasta',
    ...
    startIllustration: require('../../assets/tasks/cook-pasta/start.jpg'),
    endIllustration: require('../../assets/tasks/cook-pasta/end.jpg'),
  },
  {
    id: 'vacuum-floor',
    name: 'Vacuum floor',
    ...
    startIllustration: require('../../assets/tasks/vacuum-floor/start.jpg'),
    endIllustration: require('../../assets/tasks/vacuum-floor/end.jpg'),
  },
  {
    id: 'make-bed',
    name: 'Make the bed',
    ...
    startIllustration: require('../../assets/tasks/make-bed/start.jpg'),
    endIllustration: require('../../assets/tasks/make-bed/end.jpg'),
  },
];
