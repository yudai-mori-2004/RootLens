...
//   ユーザは両腕をまっすぐ前に伸ばし、 顔を指先に向ける。 その自然な視線状態でカメラ映像内の
//   上から 2/3 の高さに両手が映るように、 カメラの向きを物理的に微調整してもらう
//   (= 手の上に作業対象が写る余白を残す)。 許容内に来た瞬間が baseline 確定。
//   外なら「カメラをもう少し ___ に向けてください」 と方向指示
...
//        - 目標高さ ±10% 以内 → baseline 保存 + 「ヘッドセット OK、 撮影を開始します」 → カウントダウン
