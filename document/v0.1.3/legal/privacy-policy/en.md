...
- Together with the cooperating business, we post a notice at the site stating that recording is in progress, with our contact address (contact@rootlens.io). Recording staff stop filming when asked to on the spot.
- Explanation to, and consent from, adults who may appear (such as coworkers at the site) is confirmed before recording, together with the cooperating business.
