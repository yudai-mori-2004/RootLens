...
|---|---|---|---|
| `arkit` | iPhone Pro (LiDAR 有) | rgb.mp4 (H.264, 1920x1440, 15 Hz) + realtime_handpose.jsonl + imu.jsonl (~100 Hz) + metadata.json + depth.tar (256x192 mm) + pointcloud.jsonl + mesh.jsonl | `rootlens-raw-arkit` |
